...
public class Clean extends JPanel {
    ...
    public Clean() {
        ...
        JPanel quickScanCard = createScanCard("Temporary Files",
                ...
                "PythonScripts/clean/temp.py", quickScanProgress, quickScanStatus);
        ...
        JPanel fullScanCard = createScanCard("Prefetch",
                ...
                "PythonScripts/clean/prefetch.py", fullScanProgress, fullScanStatus);
        ...
        JPanel customScanCard = createScanCard("Full Clean",
                ...
                "PythonScripts/clean/temp_prefetch.py", customScanProgress, customScanStatus);
