...
//    private static final Color SUCCESS_COLOR = new Color(34, 197, 94);
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel header = new JLabel("Network Firewall");
    ...
    private JPanel createControlPanel() {
        ...
        JButton startButton = createButton("Check Ports",
                e -> executePythonScript("PythonScripts/check/open_port.py"),
                ACCENT_COLOR, ACCENT_HOVER);

        JButton stopButton = createButton("Block Ports",
                e -> executePythonScript("PythonScripts/check/block_port.py"),
