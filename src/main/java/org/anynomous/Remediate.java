...
public class Remediate extends JPanel {
    ...
    private void startScan() {
        SwingWorker<Void, String> worker = new SwingWorker<>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                String[] scripts = {"2.1.py", "2.2.py", "3.1.py"};
...
//                JOptionPane.showMessageDialog(null, "Remediation Completed!");
            }
        };
...
//            JFrame frame = new JFrame("Security Remediation");
//            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//            frame.getContentPane().add(new Remediate());
